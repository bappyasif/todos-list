...
/* harmony import */ var _saveTaskToFirebase_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./saveTaskToFirebase.js */ "./js/properAttemptForAssignment/addTasks/saveTaskToFirebase.js");
...
function showDatePickerElement(htmlElement) {
    htmlElement.addEventListener("click", () => {
        ...
        datePicker.value = (0,date_fns__WEBPACK_IMPORTED_MODULE_4__.default)((0,date_fns__WEBPACK_IMPORTED_MODULE_5__.default)(), "yyyy-MM-dd");
...
/***/ "./js/properAttemptForAssignment/addTasks/saveTaskToFirebase.js":
/*!**********************************************************************!*\
  !*** ./js/properAttemptForAssignment/addTasks/saveTaskToFirebase.js ***!
  \**********************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
let updateTaskInFirestore = (docName, prop) => {
...
/* harmony import */ var _addTasks_saveTaskToFirebase_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../addTasks/saveTaskToFirebase.js */ "./js/properAttemptForAssignment/addTasks/saveTaskToFirebase.js");
...
function showDatepicker(evt) {
    ...
    if (datePicker.style.display === "none") {
        ...
        datePicker.addEventListener("input", evt => {
            let dateValue = (0,date_fns__WEBPACK_IMPORTED_MODULE_5__.default)((0,date_fns__WEBPACK_IMPORTED_MODULE_6__.default)(datePicker.value), "MM-dd-yyyy");
            evt.target.parentNode.querySelector(".time-stamp").textContent = dateValue + ":" + (0,date_fns__WEBPACK_IMPORTED_MODULE_5__.default)((0,date_fns__WEBPACK_IMPORTED_MODULE_6__.default)(datePicker.value), "'Due_at:'eeee");
            datePicker.style.display = "none";
            ...
            (0,_addTasks_saveTaskToFirebase_js__WEBPACK_IMPORTED_MODULE_4__.updateTaskInFirestore)(taskTitle, {dueDate: dateValue});
        });
    } else {
        datePicker.style.display = "none";
        datePicker.removeEventListener("click", showDatepicker);
...
function handleProjectTodoTask(evt) {
    ...
    (0,_addTasks_saveTaskToFirebase_js__WEBPACK_IMPORTED_MODULE_4__.updateTaskInFirestore)(taskTitle, {project: evt.target.value});
}
...
function handleColorCoatingPriority(evt) {
    ...
    let taskTitle =  evt.target.parentNode.parentNode.parentNode.querySelector('.task-text').textContent;
    (0,_addTasks_saveTaskToFirebase_js__WEBPACK_IMPORTED_MODULE_4__.updateTaskInFirestore)(taskTitle, {priority: ddValue});
}
